...
const {signup,login,changePassword, sendOtp, verifyOtp, forgetPassword, resetPassword, contactMe, deleteProfile, uploadProfileImage,updateProfile} = require("../controllers/auth-controller");
