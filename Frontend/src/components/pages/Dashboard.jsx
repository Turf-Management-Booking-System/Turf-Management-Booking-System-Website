    ...
    {stats.map((stat, index) => (
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h3 className="text-sm font-serif font-medium text-gray-500 dark:text-gray-400">
              {stat.title}
            </h3>
  ...
  >
    ...
    <ul className="space-y-3">
      {bookings.map((booking) => (
        ...
        >
          <div>
            <p className="font-semibold font-sans text-gray-800 dark:text-white">
          ...
          <span
            className={`px-2 py-1 rounded-full font-montserrat text-xs font-semibold ${
