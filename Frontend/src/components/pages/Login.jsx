...
const LoginHandler = async (event) => {
  ...
  try {
    ...
    const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/v1/auth/login`, requestData, {
      headers: {
    ...
    <>
      <div  style={{
        ...
        max650:before:w-[100%] max650:before:h-[300%] max650:before:left-0 max650:before:top-[-270%]
          ${isActive ? "before:left-[50%] before:max650:top-[73%] before:max650:left-0" : "before:left-[-250%]"}`}
          >
            <div
